								...
								<div className="header-nav navbar-collapse collapse myNavbar justify-content-start" id="navbarNavDropdown"> 
									...
									<ul className="nav navbar-nav">
										<li className=""> 
											...
											<Link to={'#'} >Inicio <i className="fa fa-chevron-down"></i></Link>
										...
										<li >
											<Link to={'#'} >Publicaciones <i className="fa fa-chevron-down"></i></Link>
											<ul className="sub-menu">
										...
										<li >
											<Link to={'#'} >Trabajos <i className="fa fa-chevron-down"></i></Link>
											<ul className="sub-menu">
										...
										<li>
											<Link to={'#'}>Empresas <i className="fa fa-chevron-down"></i></Link>
											<ul className="sub-menu">
										...
										<li>
											<Link to={'#'}>PQRS <i className="fa fa-chevron-down"></i></Link>
											<ul className="sub-menu">

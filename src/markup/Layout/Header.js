  ...
  componentDidMount() {
    ...
    function checkLi(current) {
      current.parentElement.parentElement
        .querySelectorAll('li')
        .forEach(el => (current.parentElement !== el ? el.classList.remove('open') : ''))
      setTimeout(() => {
              ...
              <div className="container clearfix">
                ...
                >
                  ...
                  <ul className="nav navbar-nav">
                    <li className="">
                      <Link to={'#'}>
                        Inicio <i className="fa fa-chevron-down"></i>
                      </Link>
                    ...
                    <li>
                      <Link to={'#'}>
                        Publicaciones <i className="fa fa-chevron-down"></i>
                      </Link>
                      <ul className="sub-menu">
                        <li>
                    ...
                    <li>
                      <Link to={'#'}>
                        Trabajos <i className="fa fa-chevron-down"></i>
                      </Link>
                      <ul className="sub-menu">
                        <li>
                    ...
                    <li>
                      <Link to={'#'}>
                        Empresas <i className="fa fa-chevron-down"></i>
                      </Link>
                      <ul className="sub-menu">
                        <li>
                          ...
                          <ul className="sub-menu">
                            ...
                            <li>
                              <Link to={'/browse-job-grid'} className="dez-page">
                                browse job grid <span className="new-page">New</span>
                              </Link>
                            </li>
                            <li>
                              <Link to={'/browse-job-filter-list'} className="dez-page">
                                browse filter list <span className="new-page">New</span>
                              </Link>
                            </li>
                            <li>
                              <Link to={'/browse-job-filter-grid'} className="dez-page">
                                browse filter grid <span className="new-page">New</span>
                              </Link>
                            </li>
                          </ul>
                        </li>
                        <li>
                          ...
                          <ul className="sub-menu">
                            <li>
                              <Link to={'/category-all-jobs'} className="dez-page">
                                all jobs <span className="new-page">New</span>
                              </Link>
                            </li>
                            <li>
                              <Link to={'/category-company-jobs'} className="dez-page">
                                company jobs <span className="new-page">New</span>
                              </Link>
                            </li>
                            <li>
                              <Link to={'/category-designations-jobs'} className="dez-page">
                                designations jobs <span className="new-page">New</span>
                              </Link>
                            </li>
                            <li>
                            ...
                            <li>
                              <Link to={'/category-location-jobs'} className="dez-page">
                                location jobs <span className="new-page">New</span>
                              </Link>
                            </li>
                            <li>
                              <Link to={'/category-skill-jobs'} className="dez-page">
                    ...
                    <li>
                      <Link to={'#'}>
                        PQRS <i className="fa fa-chevron-down"></i>
                      </Link>
                      <ul className="sub-menu">
                        <li>
                        ...
                        <li>
                          <Link to={'/blog-detailed-grid-sidebar'} className="dez-page">
                  ...
                  <div className="lead-form browse-job text-left">
                    <form>
                      ...
                      <div className="clearfix">
                        <button type="button" className="btn-primary site-button btn-block">
                          Submit{' '}
                        </button>
                      </div>
                    </form>

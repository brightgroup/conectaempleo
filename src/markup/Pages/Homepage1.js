          ...
          <div className="container">
            <div className="section-head d-flex head-counter clearfix">
              <div className="mr-auto">
                <h2 className="m-b5">Empresas destacadas</h2>
        ...
        <div className="container">
          <div className="row d-flex">
            <div className="col-md-4">
              <h3>Buscar empleo por: </h3>
            </div>
            <div className="col-md-8 d-flex justify-content-end">
              <ul className="nav nav-tabs d-inline-flex text-white fs-3">
                <li className="nav nav-item pointer bg-primary">
                  <p className="nav-link ">Area funcional</p>
                </li>
                  ...
                  <div className="col-sm-12 col-md-4 col-lg-4 p-lr0">
                    <div className="pricingtable-wrapper style2 bg-white">
                      <div className="pricingtable-inner">
                        ...
                        <p>
                          Lorem ipsum dolor sit amet adipiscing elit sed do eiusmod tempors labore et dolore magna siad
                          enim aliqua
                        </p>
                        <div className="m-t20">
                          <Link to={'/register'} className="site-button radius-xl">
                  ...
                  <div className="col-sm-12 col-md-4 col-lg-4 p-lr0">
                    <div className="pricingtable-wrapper style2 bg-primary text-white active">
                      <div className="pricingtable-inner">
                        ...
                        <div className="m-t20">
                          <Link to={'/register'} className="site-button white radius-xl">

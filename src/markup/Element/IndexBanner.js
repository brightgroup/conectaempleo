				...
				<div className="container">
					<div className="dez-bnr-inr-entry align-m">
						<div className="find-job-bx">
							<h2 className='text-white'>CONECTA EMPLEO EL MEJOR ALIADO PARA TRANSFORMAR COMUNIDADES</h2>
							<form className="dezPlaceAni">
								<div className="row">
									<div className="col-lg-4 col-md-6">
										<div className="form-group">
											<label>ingrese las habilidades o titulo del trabajo</label>
									...
									<div className="col-lg-2 col-md-6">
										<button type="submit" to="/browse-job" className="site-button btn-block">BUSCAR TRABAJO</button>
									</div>
								</div>
							</form>
						</div>
